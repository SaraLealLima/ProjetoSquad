...
<head>
    ...
    <link rel="stylesheet" href="stylesObesidadeInfantil.css">
    <script src="script.js"></script>

    <title>Boquinha — Obesidade Infantil</title>
</head>
...
<body>
    ...
    <section class="section-2">
        <div><img class="imagem-section-2" src="images/prescricao.png" alt="Problemas de saúde"></div>
        <div class="section-2-texto">
            <div class="section-titulo">As consequências</div> <br>
    ...
    <section class="section-4">
        <div><img class="imagem-section-4" src="images/boaalimentacao.png" alt="Boa alimentação"></div> 
        <div class="section-4-texto">
        <div class="section-titulo">Como prevenir</div> <br>
        Uma reeducação alimentar para toda a família pode ser o primeiro — e mais
